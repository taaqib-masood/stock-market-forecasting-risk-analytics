...
**[Live Dashboard](#) · [How it works](#-architecture) · [Run it yourself](#-quick-start)**

> Live dashboard link goes live once the V-1.0 Netlify site finishes its first deploy — see [Deployment](#-deployment-netlify--github-actions).
